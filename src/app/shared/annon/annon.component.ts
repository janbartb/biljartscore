...
import { Annonceer, AnnonSerie, AnnonSpeler, AnnonTeam } from '../../model/annonceer';
...
import { AnnonWedSpel1Component } from "./annon-wed-spel1/annon-wed-spel1.component";
import { AnnonWedSpel4Component } from './annon-wed-spel4/annon-wed-spel4.component';
import { AnnonWedSpel3Component } from './annon-wed-spel3/annon-wed-spel3.component';
import { NgClass } from '@angular/common';
import { NotificationComponent } from '../notification/notification.component';
import { SpelersNamenComponent } from '../spelers-namen/spelers-namen.component';
import { HelpComponent } from '../help/help.component';
import { AnnonWedTeam2Component } from './annon-wed-team2/annon-wed-team2.component';
...
@Component({
    ...
    standalone: true,
    imports: [
        AnnonWedSpel1Component,
        AnnonWedSpel2Component,
        AnnonWedSpel3Component,
        AnnonWedSpel4Component,
        AnnonWedTeam2Component,
...
export class AnnonComponent implements OnInit {
    ...
    processEnter() {
        ...
        if (ser > 0) {
            const msgToSpeak = (this.sayGenoteerd ? 'Genoteerd, ' : '') + this.activeSpeler.splSpreekNaam + ', ' + ser;
