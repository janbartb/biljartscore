...
@Component({
    ...
    templateUrl: './os-competitie.component.html',
    styleUrl: './os-competitie.component.css'
})
export class OsCompetitieComponent extends BaseComponent implements OnInit {
    ...
    private competitieToevoegen() {
        this.bssComp.osKlasse = this.bpComp.osKlasse;
        this.bssComp.osOrg = this.bpComp.osOrg;
        this.bssComp.osComp = this.bpComp.osComp;
    ...
    ngOnInit(): void {
        ...
        console.log(this.bpComp);
        Promise.all([
            this.bssApi.getKnbbCompetities(this.bpComp.district.disId, this.bpComp.spelsoortId),
            this.bssApi.getCompFromOnzestanden(this.bpComp.osKlasse, this.bpComp.osOrg, this.bpComp.osComp)
        ])
        .then(results => {
    ...
    private createBpTeam(tm: TeamTemp): BpTeam {
        ...
        team.naam = tm.naam;
        team.bpUrl = tm.bpUrl;
        const idPosStart = team.bpUrl.indexOf('team=') + 5;
        const idPosEnd = team.bpUrl.indexOf('&organisatie=');
