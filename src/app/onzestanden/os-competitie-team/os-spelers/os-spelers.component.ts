...
@Component({
    ...
    templateUrl: './os-spelers.component.html',
    styleUrl: './os-spelers.component.css'
})
export class OsSpelersComponent extends BaseComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        .then(results => {
            ...
            if (!foundTeam) {
                this.alert.showError(`Onzestanden team ${this.bpTeam.knbbId} niet gevonden in BSS vereniging ${this.bssVereniging.naam}`);
                return;
            }
