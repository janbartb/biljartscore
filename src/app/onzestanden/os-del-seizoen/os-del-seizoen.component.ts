...
@Component({
    ...
    templateUrl: './os-del-seizoen.component.html',
    styleUrl: './os-del-seizoen.component.css'
})
export class OsDelSeizoenComponent extends BaseComponent implements OnInit {
