...
export class VerenigingComponent extends BaseComponent implements OnInit {
    ...
    wijzigButton: Button = new Button('W', 'Wijzigen', true);
    teamToevoegenButton: Button = new Button('+', 'Team', true);
    teamVerwijderenButton: Button = new Button('Del', 'Team', true);
    ledenButton: Button = new Button('L', 'Wijzigen', true);
    ...
    handleKeyboardEvent(event: KeyboardEvent): boolean {
        ...
        if (event.key === '+' || event.key === '=') {
            this.buttonPressed(event, this.teamToevoegenButton);
            return false;
        }
        if (event.code === 'KeyW') {
            this.buttonPressed(event, this.wijzigButton);
            return false;
        }
        if (event.key === 'Delete') {
            this.buttonPressed(event, this.teamVerwijderenButton);
            return false;
        }
        if (event.code === 'KeyL') {
            this.buttonPressed(event, this.ledenButton);
            return false;
        }
        if (event.key === 'Home') {
            this.homePressed();
